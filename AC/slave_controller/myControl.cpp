...
void myControl::newConnect()//连接函数
{
  tcpsocket = new QTcpSocket(this);
  connect(tcpsocket, SIGNAL(error(QAbstractSocket::SocketError)), this, SLOT(displayError(QAbstractSocket::SocketError)));
  connect(tcpsocket, SIGNAL(readyRead()), this, SLOT(readMessage()));
...
void myControl::sendMessage()//发送信息函数
{
...
void myControl::readMessage()//读取信息函数
{
...
void myControl::DealWithInstruction(QString rec_message)
{
...
void myControl::DealWithInformation(QString rec_message)
{
...
void myControl::displayError(QAbstractSocket::SocketError)
{
  qDebug() << tcpsocket->errorString(); //输出错误信息
}

int myControl::getWorkMode()
{
  return this->workMode;
}

void myControl::setWorkMode(int tt)
{
  this->workMode = tt;
  if (tt == 0) {
      QCursor cursor ;
...
double myControl::getCurrentTemp()
{
  return this->currentTemp;
}

void myControl::setCurrentTemp(double tt)
{
  this->currentTemp = tt;
}

double myControl::getConsumpt()
{
  return this->consumption;
}

double myControl::getBill()
{
  return this->bill;
}

int myControl::getLoginState()
{
  return this->loginState;
}

int myControl::getSettemp()
{
  return this->settemp;
}

int myControl::getWindSpeed()
{
  return this->windSpeed;
}

int myControl::getWorkState()
{
  return this->workState;
}

void myControl::setLoginState(int tt)
{
  this->loginState = tt;
}

void myControl::setWorkState(int tt)
{
  this->workState = tt;
  if (tt == 0) {
      QCursor cursor ;
...
void myControl::setWindSpeed(int tt)
{
  this->windSpeed = tt;
}

void myControl::setTemp(int tt)
{
  this->settemp = tt;
}

int myControl::getSlaveNo()
{
  return this->slave_no;
}

void myControl::setSlaveNo(int tt)
{
  this->slave_no = tt;
}

int myControl::getTurnOn()
{
  return this->turnOn;
}

void myControl::setTurnOn(int tt)
{
  this->turnOn = tt;
}

void myControl::on_master_button_clicked() //关闭从控机
{
  //qDebug() << "close";
  QMessageBox *msgBox = new QMessageBox();
  QList<QLabel*> textFieldLabels = msgBox->findChildren<QLabel*>();
...
void myControl::on_cool_button_clicked()
{
  QMessageBox *msgBox = new QMessageBox();
  QList<QLabel*> textFieldLabels = msgBox->findChildren<QLabel*>();
  for(int i = 0; i < textFieldLabels.size(); i++)
...
void myControl::on_warm_button_clicked()
{
  QMessageBox *msgBox = new QMessageBox();
  QList<QLabel*> textFieldLabels = msgBox->findChildren<QLabel*>();
  for(int i = 0; i < textFieldLabels.size(); i++)
...
void myControl::on_model_button_clicked()
{
...
void myControl::on_speed_button_clicked()
{
  QString description;
...
void myControl::on_windspeed_button_clicked()
{
  if(this->turnOn == turn_off)
    {
      QMessageBox *msgBox = new QMessageBox();
...
void myControl::on_up_temp_button_clicked() //调高设置温度
{
  if(this->turnOn == turn_off)
    {
      QMessageBox *msgBox = new QMessageBox();
...
void myControl::on_down_temp_button_clicked() //降低设置温度
{
  if(this->turnOn == turn_off)
    {
      QMessageBox *msgBox = new QMessageBox();
...
void myControl::on_logout_clicked()
{
...
void myControl::on_report_clicked()
{
...
void myControl::on_loginBtn_clicked()
{
...
/* 自定义关闭按钮 */
void myControl::on_close_clicked()
{
  int login_state = this->getLoginState();
  if(login_state == login_const)
    {
...
void myControl::on_again_clicked()
{
  QVector<double> x, y;
  x.clear();
  y.clear();
